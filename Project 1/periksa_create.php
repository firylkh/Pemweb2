...
<style> 
    ...
    <!--<h3 class="mt-5">Periksa</h3>-->
        ...
        <a href="periksa.php" class="btn btn-primary"><i class="fa-solid fa-arrow-left" style="color: #ffffff;"></i> <strong>Kembali</strong></a> 
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Tambah Hasil Periksa</h1>
